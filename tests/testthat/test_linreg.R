...
test_that("print() method works", {
    ...
    expect_output(linreg_mod$print(),"\\(Intercept\\) Sepal\\.Width Sepal\\.Length") # Edited
    #expect_output(linreg_mod$print()," \\(Intercept\\)   Sepal\\.Width  Sepal\\.Length ") # Original with \\
})
